...
public class PlayerCamera {
	...
	private void adjustViewPointX()
	{
		if (rightBorderReached()) {
			viewPointX = Game.getGameInstance().getMap().getTileCountX() * Game.getGameInstance().getMap().getTileSize() - Game.getGameInstance().getWidth();
		} else {
	...
	{
		return this.playerPositionX < Game.getGameInstance().getWidth() / 2 - playerTileWidth / 2 || Game.getGameInstance().getMap().getTileCountX() * Game.getGameInstance().getMap().getTileSize() <= Game.getGameInstance().getWidth();
	}
	
	private boolean rightBorderReached()
	{
		return this.playerPositionX > Game.getGameInstance().getMap().getTileCountX() * Game.getGameInstance().getMap().getTileSize() - Game.getGameInstance().getWidth() / 2 - playerTileWidth / 2;
	}
	
	private void adjustViewPointY()
	{
		if (bottomBorderReached()) {
			viewPointY = Game.getGameInstance().getMap().getTileCountY() * Game.getGameInstance().getMap().getTileSize() - Game.getGameInstance().getHeight();
		} else {
	...
	{
		return this.playerPositionY > Game.getGameInstance().getMap().getTileCountY() * Game.getGameInstance().getMap().getTileSize() - Game.getGameInstance().getHeight() / 2 - playerTileHeight / 2;
	}
	
	private boolean topBorderReached()
	{
		return this.playerPositionY < Game.getGameInstance().getHeight() / 2 - playerTileHeight / 2 || Game.getGameInstance().getMap().getTileCountY() * Game.getGameInstance().getMap().getTileSize() <= Game.getGameInstance().getHeight();
	}
